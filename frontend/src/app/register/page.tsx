    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 shadow-xl shadow-indigo-500/30 mb-3">
        ...
        <div className="glass-card auth-glow p-6">
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="pt-2 border-t border-white/5 space-y-3">
              <p className="text-indigo-300 text-xs font-semibold uppercase tracking-wider flex items-center gap-1.5">
